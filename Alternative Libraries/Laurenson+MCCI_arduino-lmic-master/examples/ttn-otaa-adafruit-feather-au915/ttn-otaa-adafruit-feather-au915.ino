 ...
 *
 * Sketch Summary:
 * Target device: Adafruit Feather M0 LoRa AU915
...
// Pin mapping
// TL Modifications:
// Specifically for Adafruit Feather M0 LoRa AU915MHz
...
void setup() {
    while (!Serial); // wait for Serial to be initialized. Comment out this line if you want to run your Feather without USB connectivity
    Serial.begin(115200);
